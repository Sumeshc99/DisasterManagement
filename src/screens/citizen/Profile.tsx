            ...
            <View style={styles.tabContainer}>
                ...
                >
                    <View style={styles.tabContent}>
                        ...
                        >
                            <Polygon
                                points="5,5 200,5 215,25 200,45 5,45 5,5"
                                fill={activeTab === "basic" ? "#0D5FB3" : "#FFFFFF"}
                                stroke="#D3D3D3"
                                strokeWidth="2"
                            />
                        </Svg>
                ...
                <TouchableOpacity
                    style={[styles.tab, styles.secondTab, activeTab === "emergency" && styles.activeZ]}
                ...
                >
                    <View style={styles.tabContent}>
                        <Svg
                            ...
                            preserveAspectRatio="none"
                        >
                            {/* The trick: reverse the arrow on left side for smooth connection */}
                            <Polygon
                                points="0,25 15,5 210,5 210,45 15,45 0,25"
                                fill={activeTab === "emergency" ? "#0D5FB3" : "#FFFFFF"}
                                stroke="#D3D3D3"
                                strokeWidth="2"
                            />
                        </Svg>
                ...
                {activeTab === 'basic' ? (
                    <View style={styles.form}>
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            >
                                <Text style={formData.block ? styles.dropdownText : styles.dropdownPlaceholder}>
                                    ...
                                    {blocks.map((block) => (
                                        <TouchableOpacity
                                            ...
                                            onPress={() => {
                                                ...
                                                if (errors.block) setErrors({ ...errors, block: undefined });
                                            }}
                                        >
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            >
                                <Text style={formData.dateOfBirth ? styles.dropdownText : styles.dropdownPlaceholder}>
                    ...
                    <View style={styles.form}>
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            {errors.primaryContactName && (
                                <Text style={styles.errorText}>{errors.primaryContactName}</Text>
                            )}
                        </View>
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            >
                                <Text style={formData.relation ? styles.dropdownText : styles.dropdownPlaceholder}>
                                    ...
                                    {relations.map((relation) => (
                                        <TouchableOpacity
                                            ...
                                            onPress={() => {
                                                ...
                                                if (errors.relation) setErrors({ ...errors, relation: undefined });
                                            }}
                                        >
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            {errors.primaryContactNumber && (
                                <Text style={styles.errorText}>{errors.primaryContactNumber}</Text>
                            )}
                        </View>
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            <TextInput
                                ...
                                onChangeText={(text) => setFormData({ ...formData, alternateMobileNumber: text })}
                                keyboardType="phone-pad"
                                maxLength={10}
                            />
                        </View>
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            <TextInput
                                ...
                                onChangeText={(text) => setFormData({ ...formData, secondaryContactName: text })}
                            />
                        </View>
...
const styles = StyleSheet.create({
    ...
    secondTab: {
        marginLeft: -20, // overlap the arrow shape for continuous design
    },
    tabContent: {
        flex: 1,
        justifyContent: "center",
